...
#define MSVC_SPECIFIC 1
#if MSVC_SPECIFIC
    macros.insert(std::make_pair("_MSC_VER", Macro("_MSC_VER", "1929", files)));
    macros.insert(std::make_pair("__cpp_fold_expressions", Macro("__cpp_fold_expressions", "1", files)));
    macros.insert(std::make_pair("_WIN32", Macro("_WIN32", "_WIN32", files)));
    macros.insert(std::make_pair("__ATOM__", Macro("__ATOM__", "0", files)));
    macros.insert(std::make_pair("_M_X64", Macro("_M_X64", "100", files)));
    macros.insert(std::make_pair("_M_AMD64", Macro("_M_AMD64", "100", files)));
    //later convert this to check at runtime if the actual include is available
    //macros.insert(std::make_pair("__has_include(n)", Macro("__has_include(n)", "1", files)));
